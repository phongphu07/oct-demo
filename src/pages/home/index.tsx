...
const items = [
  {
    ...
    description:
      "OCT imaging enables detection of retinal pathologies and cardiovascular diseases in their preclinical stages, often before symptoms manifest, dramatically improving treatment success rates and patient prognosis.",
    color: "#4F87FF",
  },
  {
    icon: TrendingUp,
    ...
    description:
      "Advanced deep learning algorithms identify subtle morphological patterns and microstructural changes that may escape human detection, reducing diagnostic uncertainty and improving clinical decision-making.",
    color: "#3AB83A",
  },
  {
    icon: Zap,
    ...
    description:
      "Automated AI analysis reduces image interpretation time from hours to minutes, enabling higher patient throughput and faster treatment initiation while maintaining diagnostic excellence.",
    color: "#3172FF",
  },
];
...
const author = [
  {
    ...
    role: "CEO & Founder",
    description:
      "Vitreoretinal Specialist • 15+ years in retinal imaging • Harvard Medical School",
    image:
  ...
  },
  {
    ...
    role: "AI Innovator",
    description:
      "Computer Vision & Deep Learning • MIT • 50+ peer-reviewed publications",
    image:
  ...
  },
  {
    ...
    role: "AI Engineer",
    description:
      "Medical Image Processing • Stanford University • FDA regulatory expert",
    image:
...
export default function HomePage() {
  ...
  return (
    ...
    <div className="mx-auto max-w-screen-2xl pt-24 pb-12 flex flex-col items-center justify-start">
      <div className="flex flex-col gap-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center justify-between">
          <div className="gap-6 flex flex-col items-start justify-start">
            ...
            <p className="md:text-xl text:md leading-relaxed">
              Advanced artificial intelligence system that revolutionizes
              Optical Coherence Tomography image analysis, delivering enhanced
              diagnostic accuracy and clinical efficiency for ophthalmologists,
              cardiologists, and medical professionals worldwide.
            </p>

            <div className="flex gap-4">
              <Button
                onClick={() => scrollToSection("demo")}
                className="px-8 py-2 bg-[#4F87FF] hover:bg-[#000] "
              >
                Try Demo
              </Button>
        ...
        {/* end section1 */}
        {/* About the Project */}
        <section id="about" className="py-10 bg-gray-50 relative z-10">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Develop a cutting-edge AI system that automatically
                      analyzes OCT images to detect retinal diseases and
                      cardiovascular conditions with high accuracy.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Applications in ophthalmology for early detection of
                      diabetic retinopathy, macular degeneration, and glaucoma.
                      Also supports intravascular OCT in cardiology.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ophthalmologists, cardiologists, radiologists, residents,
                      and healthcare providers aiming for precise diagnosis and
                      optimized workflows.
                    </p>
                  </div>
                </div>
          ...
          <div className="">
            <div className="flex flex-col gap-8 items-center justify-center">
              ...
              <p className="text-xl max-w-3xl mx-auto">
                The critical role of AI-assisted OCT analysis in modern
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="text-medium-text">
                            463 million people worldwide at risk for diabetic
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="text-medium-text">
                            Early AI-assisted detection prevents 95% of severe
                            vision loss cases
                          </span>
                        </div>
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="text-medium-text">
                            Automated screening reduces healthcare costs by up
                            to 60% while improving access
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-6 hover:shadow-lg transition-transform hover:-translate-y-1">
                ...
                <p className="text-medium-text mb-4">
                  State-of-the-art real-time object detection algorithm for
                  precise identification and localization of pathological
                  features, drusen deposits, hemorrhages, and anatomical
                  landmarks in OCT images. Custom-trained with medical imaging
                  datasets and optimized anchor boxes for retinal pathology
                  detection.
                </p>
              </Card>
              ...
              <Card className="p-6 hover:shadow-lg transition-transform hover:-translate-y-1">
                ...
                <p className="text-medium-text mb-4">
                  Advanced convolutional neural network architecture optimized
                  for pixel-perfect segmentation of retinal tissue layers,
                  intraretinal fluid accumulations, subretinal deposits, and
                  precise anatomical boundary delineation in high-resolution OCT
                  scans. Features encoder-decoder design for medical image
                  analysis.
                </p>
              </Card>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {author.map((member, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center bg-white p-6 rounded-xl shadow-md border-t hover:shadow-lg transition-transform hover:-translate-y-1"
            >
              <img
                src={member.image}
              ...
              <p className="text-medical-blue font-medium">{member.role}</p>
            </div>
          ))}
        </div>
        ...
        {/* something else */}
        <section
          className="relative w-full h-[400px] bg-gradient-to-r from-[#8b8b8b] to-[#505050] overflow-hidden rounded-2xl shadow-2xl"
          id="demo"
        >
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white p-6">
            ...
            <p className="text-lg md:text-xl mb-6 max-w-2xl text-gray-200">
              Experience AI-powered OCT image analysis to support doctors in
